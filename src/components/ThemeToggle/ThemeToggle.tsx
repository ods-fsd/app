...
export default function ThemeToggle() {
  ...
  return (
    <button 
      ...
      aria-label={theme === 'color-scheme-3' ? 'Увімкнути світлу тему' : 'Увімкнути темну тему'}
    >
      {theme === 'color-scheme-3' ? (
        
        <svg viewBox="0 0 24 24" width="24" height="24" className={css.icon} aria-hidden="true">
